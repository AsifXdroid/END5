...
hl.bind("SUPER + A", hl.dsp.global("quickshell:wallpaperSelectorToggle"),
    { description = "Shell: Change wallpaper" })
...
hl.bind("SUPER + SHIFT + G", hl.dsp.global("quickshell:regionSearch"), { description = "Utilities: Google Lens" })
hl.bind("SUPER + SHIFT + G", hl.dsp.exec_cmd(qsIsAlive .. " || pidof slurp || " .. hyprScripts .. "/snip_to_search.sh"))
--# OCR
...
hl.bind("SUPER + mouse:274", hl.dsp.window.resize(), { mouse = true, description = "Window: Resize (middle)" })
hl.bind("SUPER + mouse:273", hl.dsp.window.resize(), { mouse = true, description = "Window: Resize" })
hl.bind("CTRL + SUPER + mouse:272", hl.dsp.window.resize(), { mouse = true, description = "Window: Resize (ctrl)" })
...
hl.bind("SUPER + SHIFT + Q", hl.dsp.exec_cmd("hyprctl kill"), { description = "Window: Kill stuck app" })
hl.bind("SUPER + SHIFT + ALT + Q", hl.dsp.exec_cmd("hyprctl kill"), { description = "Window: Forcefully zap a window" })
hl.bind("SUPER + Z", hl.dsp.exec_cmd("zapzap"), { description = "App: ZapZap (WhatsApp)" })
--# Window split ratio
...
-- SUPER + C moved to custom/keybinds.lua and rebound to Telegram
...
hl.bind("Scroll_Lock", hl.dsp.exec_cmd("$HOME/.config/hypr/hyprland/scripts/scrolllock_toggle.sh"))
--# Cursed stuff
