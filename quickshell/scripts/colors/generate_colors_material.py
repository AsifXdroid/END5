...
if 'primary_paletteKeyColor' not in material_colors:
    material_colors['primary_paletteKeyColor'] = rgba_to_hex(MaterialDynamicColors.primaryPaletteKeyColor.get_hct(scheme).to_rgba())
