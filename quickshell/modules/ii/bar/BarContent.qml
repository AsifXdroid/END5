...
Item {
    ...
    readonly property bool islandSolo: false // Island always shows alongside bar
    ...
    Rectangle {
        id: centerPill
        visible: centerOnly && Config.options.bar.showBackground && Config.options.bar.cornerStyle !== 2 && !root.islandActive
    ...
    Item {
        ...
        Item {
            ...
            Rectangle {
                ...
                visible: root.isMaterial && !root.islandActive
                anchors.centerIn: parent
