...
Scope {
    ...
    Variants {
        ...
        LazyLoader {
            ...
            component: PanelWindow { // Bar window
                ...
                property bool mustShow: !Config.options.bar.autoHide.enable || !hasWin || hoverRegion.containsMouse || superShow
    ...
    CompositorGlobalShortcut {
        name: "islandToggle"
        description: "Toggles island clock dashboard on press"
