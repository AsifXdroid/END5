...
ContentPage {
    ...
    function activeLayouts() {
        return Config.options.bar.vertical
            ? Config.options.bar.verticalBar.layouts
            : Config.options.bar.layouts
    }
        ...
        ContentSection {
            ...
            GroupedList {
                LayoutSection {
                    ...
                    layout: activeLayouts().leftLayout
                    availableWidgets: page.availableFor()
                    getWidgetName: page.getWidgetName
                    onUpdate: list => activeLayouts().leftLayout = list
                }

                LayoutSection {
                    sectionTitle: Translation.tr("Center")
                    layout: activeLayouts().middleLayout
                    availableWidgets: page.availableFor()
                    getWidgetName: page.getWidgetName
                    onUpdate: list => activeLayouts().middleLayout = list
                }

                LayoutSection {
                    sectionTitle: Config.options.bar.vertical ? Translation.tr("Bottom") : Translation.tr("Right")
                    layout: activeLayouts().rightLayout
                    availableWidgets: page.availableFor()
                    getWidgetName: page.getWidgetName
                    onUpdate: list => activeLayouts().rightLayout = list
                }
            }
        }
