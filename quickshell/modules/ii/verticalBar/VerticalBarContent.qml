...
Item {
    ...
    readonly property var effectiveLeftLayout:   filterLayout(Config.options.bar.verticalBar.layouts.leftLayout)
    readonly property var effectiveMiddleLayout: filterLayout(Config.options.bar.verticalBar.layouts.middleLayout)
    readonly property var effectiveRightLayout:  filterLayout(Config.options.bar.verticalBar.layouts.rightLayout)
