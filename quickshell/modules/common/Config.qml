    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject bar: JsonObject {
                ...
                property int cornerStyle: 0 // 0: Hug | 1: Float | 2: Islands | 3: M3
                ...
                property JsonObject verticalBar: JsonObject {
                    property JsonObject layouts: JsonObject {
                        property list<string> leftLayout: []
                        property list<string> middleLayout: ["workspaces", "clockWidget", "sysTray"]
            ...
            property JsonObject island: JsonObject {
                property bool alwaysFloat: true
                property bool showDailyGoals: true
                property bool showQuickApps: true
                property bool showQuickTools: true
                property bool showHardwareTelemetry: true
                property bool showMediaCard: true
                property bool showNotifications: true
                property bool enabled: true
                property bool barWithIsland: false // false=Island Only (bar sides hidden), true=Bar+Island
                property bool outsideCollapse: true // click outside collapses clock/launcher/notification
                property bool mediaExpands: true
                property bool autoExpandMedia: true
                property bool idleWorkspaces: false
                property bool idleClock: true
                property bool idleTray: false
                property bool idleBattery: false
                property bool expandNotifications: true
                property bool inlineOsd: true
                property bool enableLauncher: true
                property bool hoverExpand: false
                property int hoverExpandAction: 0 // 0=none, 1=clock, 2=launcher
                property list<string> chips: []
                property bool homeUsercard: true
                property bool homeHero: true
                property bool homeBattery: true
                property bool sysCpu: true
                property bool sysRam: true
                property bool sysZram: true
                property bool sysGpu: true
                property bool sysDisk: true
                property bool sysTemp: true
                property list<var> utilityToggles: [
                    { type: "network", size: 1 },
                    { type: "bluetooth", size: 1 },
                    { type: "audio", size: 1 },
                    { type: "mic", size: 1 },
                ...
                property bool footTray: true
                property bool footWallpaper: true
                property bool footOcr: true
                property bool footLock: true
                property bool footUptime: true
            }
